...
class LidarProcessing:
    ...
    def construct_birds_eye_view(self, data):
        ...
        filter_front_left = np.logical_and(filter_left, x_points > 0)
        ...
        # print("front left", self.x_front_left)
        # print("front left", self.y_front_left)

        # Getting sensor reading for rear left
        filter_rear_left = np.logical_and(filter_left, x_points < 0)
        ...
        # print("rear left", self.x_rear_left)
        # print("rear left", self.y_rear_left)

        # Getting sensor reading for front right
        filter_front_right = np.logical_and(filter_right, x_points > 0)
        ...
        # print("front right", self.x_front_right)
        # print("front right", self.y_front_right)

        # Getting sensor reading for rear right
        filter_rear_right = np.logical_and(filter_right, x_points < 0)
        # filter_rear_right = np.logical_and(filter_rear, y_points < 0)
        ...
        # print("rear right", self.x_rear_right)
        # print("rear right", self.y_rear_right)
    ...
    def processLidar(self):
        ...
        return [front*100, right*100, rear*100, left*100, front_right*100, rear_right*100, rear_left*100, front_left*100]
